        ...
        raw_items = [
            {
                ...
                "published_at": (now - timedelta(minutes=3)).toISOString(),
                "time_ago": "3 mins ago",
                "viability_score": 94,
            ...
            },
            {
                ...
                "published_at": (now - timedelta(minutes=14)).toISOString(),
            ...
            },
            {
                ...
                "published_at": (now - timedelta(minutes=28)).toISOString(),
            ...
            },
            {
                ...
                "published_at": (now - timedelta(minutes=45)).toISOString(),
            ...
            },
            {
                ...
                "published_at": (now - timedelta(hours=1, minutes=10)).toISOString(),
                "time_ago": "1 hour ago",
                "viability_score": 86,
